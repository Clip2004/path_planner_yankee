...
def generate_launch_description():
    ...
    path_planner_dijkstra_improved_node_yankee = Node(
        package='path_planner_yankee',
        executable='path_planner_dijkstra_improved_node_yankee',
        name='path_planner_dijkstra_improved_node_yankee',
    ...
    return LaunchDescription([
        path_planner_dijkstra_improved_node_yankee,
